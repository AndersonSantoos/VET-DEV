    ...
    included do
      swagger_path '/veterinarios' do
        ...
        operation :post do
          ...
          parameter name: :veterinario, in: :body, required: true, description: 'Dados do veterinário', schema: { '$ref' => :VeterinarioInput }
          response 201 do
      ...
      swagger_path '/veterinarios/{id}' do
        ...
        operation :put do
          ...
          key :produces, ['application/json']
          key :consumes, ['application/json']
          parameter name: :veterinario, in: :body, required: true, description: 'Dados atualizados do veterinário', schema: { '$ref' => :VeterinarioInput }
          response 200 do
